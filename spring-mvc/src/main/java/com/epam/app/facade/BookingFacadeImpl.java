...
import com.epam.app.service.EventService;
import com.epam.app.service.TicketService;
...
public class BookingFacadeImpl implements BookingFacade {
    ...
    public List<Event> getEventsByTitle(String title, int pageSize, int pageNum) {
        isPageSizeIsPositiveOrThrowException(pageSize, pageNum);
        List<Event> events = eventService.retrieveEventByTitle(title);
    ...
    public List<Event> getEventsForDay(Date day, int pageSize, int pageNum) {
        isPageSizeIsPositiveOrThrowException(pageSize, pageNum);
        List<Event> events = eventService.retrieveEventByDay(day);
        LOG.debug("Events: {}", events);
        return events.isEmpty() ? Collections.emptyList() : listByPage(events, pageSize, pageNum);
    }
    ...
    public List<User> getUsersByName(String name, int pageSize, int pageNum) {
        isPageSizeIsPositiveOrThrowException(pageSize, pageNum);
        List<User> users = userService.retrieveUserByName(name);
    ...
    public Ticket bookTicket(long userId, long eventId, int place, Ticket.Category category) {
        ...
        bookedTickets.stream()
                .filter(ticket -> place == ticket.getPlace() && category.equals(ticket.getCategory()) && userId == ticket.getUserId())
                .findFirst()
                .ifPresent(ticket -> {
    ...
    private void isPageSizeIsPositiveOrThrowException(int pageSize, int pageNum) {
